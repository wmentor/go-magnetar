...
| Уровень | Когда |
|---|---|
| `DEBUG` | Детали вызовов инструментов (имя, аргументы) |
| `INFO` | Начало/конец индексации файла, создание коллекции, финальный ответ LLM |
| `WARN` | Перезапись существующего документа в Qdrant |
| `ERROR` | Ошибки чтения файлов, сбои embedding/Qdrant, ошибки LLM |
